...
if (isset($argv[4])) {
	...
	$total = intval(array_pop(@pg_fetch_assoc(@pg_query($pg, "SELECT COUNT(*) FROM \"PortIPs\".\"".date('Y-m-d', $date)."\" WHERE (\"internalIP\"= '".$host."' ) AND (port= '80' ) AND (initiator= '2' )"))));
