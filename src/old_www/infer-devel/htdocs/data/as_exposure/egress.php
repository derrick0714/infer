...
$ht = @pg_query($pg, "SELECT \"as\".\"asn\", \"asName\", \"asDescription\", \"as\".\"internal_hosts_contacted\", \"as\".\"ingress_bytes\", \"as\".\"egress_bytes\" FROM \"Maps\".\"asNames\" INNER JOIN (SELECT * FROM \"ASExposure\".\"".date('Y-m-d', $date)."\" WHERE asn != '0' ORDER BY \"egress_bytes\" DESC LIMIT 10) AS \"as\" ON \"asNumber\" = \"as\".\"asn\"");
