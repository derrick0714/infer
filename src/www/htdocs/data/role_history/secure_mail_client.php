...
$ms = @pg_fetch_assoc(@pg_query($pg, "SELECT \"ports\", \"initiator\" FROM \"Maps\".\"monitoredServices\" WHERE \"name\" = 'Secure Mail Client'"));
...
$role = array(
	"role" => array(
		"name" => "secure_mail_client",
		"display_name" => "Secure Mail Client",
		"history" => $history
	)
);
