...
if($host)
{
	$ms = @pg_fetch_assoc(@pg_query($pg, "SELECT \"ports\", \"initiator\" FROM \"Maps\".\"monitoredServices\" WHERE \"name\" = 'Secure Web Server'"));
...
$role = array(
	"role" => array(
		...
		"display_name" => "Secure Web Server",
		"history" => $history
	)
);
