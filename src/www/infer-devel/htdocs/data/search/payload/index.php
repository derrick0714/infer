...
$result_set=@pg_query($pg,'SELECT "id" from "Indexes"."payloadQueries"');
...
$query='SELECT "id","name","username","startTime","status",\'Payload\' AS "type" from "Indexes"."payloadQueries" ' . $where;
if(sizeof($orderBy)>0){
	$query.=' Order By';
