...
$ms = @pg_fetch_assoc(@pg_query($pg, "SELECT \"ports\", \"initiator\" FROM \"Maps\".\"monitoredServices\" WHERE \"name\" = 'Secure Mail Server'"));
...
$role = array(
	"role" => array(
		"name" => "secure_mail_server",
		"display_name" => "Secure Mail Server",
		"history" => $history
	)
);
