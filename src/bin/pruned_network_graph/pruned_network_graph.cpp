...
int main(int argc, char *argv[]) {
	...
	if (conf.get(host_index_schema, "host-index-schema", "pruned_network_graph")
			!= configuration::OK)
	{
	...
	if (conf.get(host_index_pair_schema, "host-index-pair-schema", "pruned_network_graph")
			!= configuration::OK)
	{
	...
	string stats_schema;
	if (conf.get(stats_schema, "stats-schema", "pruned_network_graph")
			!= configuration::OK)
	{
	...
	if (conf.get(network_stats_table, "network-stats-table", "pruned_network_graph")
			!= configuration::OK)
	{
	...
	if (conf.get(privacy_threshold, "privacy-threshold", "pruned_network_graph")
			!= configuration::OK)
	{
