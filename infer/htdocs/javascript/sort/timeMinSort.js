<!--
function timeMinSort(tableID, columnID, elementIdentifier)
{ 
	if(!overThousandRecords)//confirm that the user want to proceed
	{
	   timeMSort(tableID, columnID, elementIdentifier)
	   return;
	}
...
function timeMSort(tableID, columnID, elementIdentifier)
{
