/* 
 * File:   NetFlowARL_v2_Record.h
 * Author: Mike
 *
 * Created on August 4, 2009, 9:11 PM
 */

#ifndef _NETFLOWARL_V2_RECORD_H
#define	_NETFLOWARL_V2_RECORD_H
...
namespace vn {
    namespace arl {
        namespace shared {
            ...
            class NetFlowARL_v2_Record : public NetFlowARLRecord {
            ...
            public:
                NetFlowARL_v2_Record();
                virtual ~NetFlowARL_v2_Record();
