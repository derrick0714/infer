#ifndef HBFQUERYPROCESSORARGUMENTS_H
#define HBFQUERYPROCESSORARGUMENTS_H
...
class HBFQueryProcessorArguments : public SynappArguments {
  public:
	/// \brief Constructor
	...
	explicit HBFQueryProcessorArguments(int argc, char **argv);
