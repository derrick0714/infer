/* 
 * File:   DNSFreeFlowsArguments.h
 * Author: Mikhail Sosonkin
 *
 * Created on December 2, 2009, 10:27 PM
 */

#ifndef _DNSFREEFLOWSARGUMENTS_H
#define	_DNSFREEFLOWSARGUMENTS_H
...
namespace vn {
    namespace arl {
        namespace symptom {
            ...
            class DNSFreeFlowsArguments : public SynappArguments {
            public:
                /// \brief Constructor
                /// \param argc The number of arguments, including the executable name
                /// \param argv The arguments, including the executable name
                ///
                /// Construct a DNSFreeFlowsArguments.
                explicit DNSFreeFlowsArguments(int argc, char **argv);
            ...
            private:
                ...
                boost::filesystem::path _inputNetFile;

                /// The value of the config-file command-line option
                boost::filesystem::path _inputPcapFile;
