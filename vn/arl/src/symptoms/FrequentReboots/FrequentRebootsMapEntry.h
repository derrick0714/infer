/* 
 * File:   FrequentRebootsMapEntry.h
 * Author: Mike
 *
...
namespace vn {
    namespace arl {
        namespace symptom {
            ...
            class FrequentRebootsMapEntry {
            public:
                explicit FrequentRebootsMapEntry(const NetFlowARLRecord& netflow, const TimeStamp& stamp, const bool isdark);

                FrequentRebootsMapEntry(const FrequentRebootsMapEntry& orig);
            ...
            private:
                ...
                /// \brief we save the offending flow in a FrequentRebootsEntry class
                ///        for easy retrieval.
                NetflowEntry flow;
